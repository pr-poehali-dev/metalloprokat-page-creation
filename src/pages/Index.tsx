          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              <div className="space-y-6 text-base leading-relaxed" style={{ color: "hsl(40,10%,60%)" }}>
                <p><span className="text-white font-medium">СтальПром</span> — ведущий поставщик металлопроката в регионе с 2008 года. За 16 лет работы мы выстроили надёжную цепочку поставок от крупнейших металлургических заводов России.</p>
      ...
      <footer className="border-t py-8 px-4" style={{ borderColor: "hsl(20,8%,15%)" }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-center" style={{ color: "hsl(40,10%,40%)" }}>
            © 2008–2026 ООО «СтальПром». Все права защищены.<br />ИНН 6600000000 · ОГРН 1086600000000
          </div>
